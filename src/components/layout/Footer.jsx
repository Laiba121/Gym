          ...
          <div className="max-w-[95%] lg:max-w-7xl mx-auto px-4 sm:px-6 md:px-10 py-16 sm:py-20 lg:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr_0.8fr] gap-10 lg:gap-14">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="mt-4 sm:mt-6 text-[14px] sm:text-[18px] lg:text-[22px] uppercase tracking-[0.2em] text-[#ff4d2d]">
                  Core Strength
                </p>
              </div>
              ...
              <div className="relative pl-0 lg:pl-10 text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-2 mb-6">
                  ...
                  />
                  <h3 className="text-xl sm:text-2xl font-extrabold tracking-[0.15em]">
                    QRGYM
                  </h3>
                </div>
                ...
                <p className="text-[#ff4d2d] uppercase tracking-widest text-xs sm:text-sm mb-1">
                  Call Us Anytime
                </p>
